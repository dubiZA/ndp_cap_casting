...
class CastingApiTestCase(unittest.TestCase):
    ...
    def test_get_actors_success(self):
        ...
        headers = {'Authorization': f'Bearer {str(TOKEN_ASSISTANT)}'}
    ...
    def test_post_actor_success(self):
        ...
        headers = {'Authorization': f'Bearer {str(TOKEN_DIRECTOR)}'}
        payload = {'name': 'Bozwil', 'age': 43, 'gender': 'f'}

        response = self.client().post('/actors', headers=headers, json=payload)
        data = json.loads(response.data)
    ...
    def test_post_movie_success(self):
        ...
        headers = {'Authorization': f'Bearer {str(TOKEN_PRODUCER)}'}
        payload = {'title': 'Wilky', 'release_date': '2012-02-13'}

        response = self.client().post('/movies', headers=headers, json=payload)
        data = json.loads(response.data)
    ...
    def test_delete_actor_success(self):
        ...
        headers = {'Authorization': f'Bearer {str(TOKEN_DIRECTOR)}'}
        response = self.client().delete(f'/actors/{actor_id}', headers=headers)
        data = json.loads(response.data)
    ...
    def test_delete_movie_success(self):
        ...
        headers = {'Authorization': f'Bearer {str(TOKEN_PRODUCER)}'}
        response = self.client().delete(f'/movies/{movie_id}', headers=headers)
        data = json.loads(response.data)
    ...
    def test_get_actors_not_found(self):
        ...
        headers = {'Authorization': f'Bearer {str(TOKEN_ASSISTANT)}'}
        response = self.client().get('/actors?page=100000', headers=headers)
        data = json.loads(response.data)
    ...
    def test_get_movies_not_found(self):
        ...
        headers = {'Authorization': f'Bearer {str(TOKEN_ASSISTANT)}'}
        response = self.client().get('/movies?page=100000', headers=headers)
        data = json.loads(response.data)
    ...
    def test_post_actor_bad_data(self):
        '''Test successfully adding new actor'''
        headers = {'Authorization': f'Bearer {str(TOKEN_DIRECTOR)}'}
        payload = {'first_name': 'Oops', 'age': 43, 'gender': 'f'}
    ...
    def test_post_movie_bad_data(self):
        '''Test successfully adding a new movie'''
        headers = {'Authorization': f'Bearer {str(TOKEN_PRODUCER)}'}
        payload = {'title': 'Wilky', 'date': '2012-02-13'}
